...
export class OrangeFooter extends HTMLElement {
	...
	connectedCallback() {
		...
		if (this.hasAttribute('show-bar') === false || this.getAttribute('show-bar') === 'true') {
